                    ...
                    <form method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control" id="category_id" name="category_id" required>
                                ...
                                <?php foreach ($categories as $category): ?>
                                    <option value="<?= (int)$category['id'] ?>" <?= $category['id'] == $product['category_id'] ? 'selected' : '' ?>>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control" id="price" name="price" step="0.01" value="<?= number_format($product['price'] ?? 0, 2) ?>" required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="stock_quantity" class="form-label">Кількість на складі *</label>
                                <input type="number" class="form-control" id="stock_quantity" name="stock_quantity" value="<?= (int)($product['stock_quantity'] ?? 0) ?>" required>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="flavor" name="flavor" value="<?= htmlspecialchars($product['flavor'] ?? '') ?>">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="nicotine_content" class="form-label">Вміст нікотину</label>
                                <input type="number" class="form-control" id="nicotine_content" name="nicotine_content" step="0.1" value="<?= (float)($product['nicotine_content'] ?? 0) ?>">
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="is_active" name="is_active" value="1" <?= ($product['is_active'] ?? 0) ? 'checked' : '' ?>>
